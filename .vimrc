...
set wildmenu
syntax enable
"start with default cpp template
autocmd BufNewFile *.cpp :0r ~/.vim/cpp
"start with default c template
autocmd BufNewFile *.c :0r ~/.vim/c
autocmd BufNewFile *.cpp :w!
autocmd BufNewFile *.c :w!
autocmd BufNewFile *.java :0r ~/.vim/java
autocmd BufNewFile *.java :w!
"execute c++ file
nnoremap <C-c> :!g++ -o  %:r.out % -std=c++11<Enter>
nnoremap <C-x> :!./%:r.out
nnoremap <C-i> :!./%:r.out < %:r.txt
map F :!-std = c++0x -O2 -static -s -lm -DONLINE_JUDGE<CR>
map <F5> :!g++ -g % <CR>
